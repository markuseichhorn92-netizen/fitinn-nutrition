      ...
      <div className="sticky top-0 bg-white z-20 shadow-sm">
        ...
        <div className="px-4 lg:px-8 py-3 flex items-center justify-between border-b border-gray-100">
          ...
          <div className="flex items-center gap-1 sm:gap-3">
            ...
            <button onClick={exportPDF} className="px-3 py-2 text-sm font-medium text-gray-600 hover:text-teal-600 hover:bg-gray-50 rounded-lg transition-colors flex items-center gap-1.5">
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
